...
/**
 * Psyche (“You”) entry film — plays when opening natal / self.
 * Black → film → fade → live Psyche. Tap skips. Once per tab session.
 * Muted autoplay (same contract as Agon / orrery / boot splash).
 */
...
export function OnyxPsycheSplash({ onEnter }: { onEnter: () => void }) {
      ...
      <div className="onyx-device onyx-splash-only">
        <div className="onyx-film">
          <video
            ...
            onEnded={finish}
          >
            <source src={`/psyche-intro.mp4?v=${DELPHI_BUILD}`} type="video/mp4" />
          </video>
        </div>
